...
string characterBannerVersion = "clorinde-1";
vector<string> characterRateupBanner;
string weaponBannerKeyword = "Absolution - Light of Foliar Incision";
vector<string> weaponRateupBanner;
...
unordered_map<string, vector<string>> characterBannerList = {
	...
	{"wanderer-3", {"Wanderer (5-Star)", "Beidou (4-Star)", "Faruzan (4-Star)", "Layla (4-Star)"}},
	{"baizhu-3", {"Baizhu (5-Star)", "Beidou (4-Star)", "Faruzan (4-Star)", "Layla (4-Star)"}},
	{"clorinde-1", {"Clorinde (5-Star)", "Sethos (4-Star)", "Thoma (4-Star)", "Bennett (4-Star)"}},
	{"alhaitham-3", {"Alhaitham (5-Star)", "Sethos (4-Star)", "Thoma (4-Star)", "Bennett (4-Star)"}}
};
...
unordered_map<string, vector<string>> weaponBannerList = {
	...
	{"Tulaytullah's Remembrance - Jadefall's Splendor", {"Tulaytullah's Remembrance (5-Star)", "Jadefall's Splendor (5-Star)",  "Range Gauge (4-Star)", "Favonius Sword (4-Star)", "Sacrificial Fragments (4-Star)", "Prospector's Drill (4-Star)", "Rainslasher (4-Star)"}},
	{"Absolution - Light of Foliar Incision", {"Absolution (5-Star)", "Light of Foliar Incision (5-Star)",  "Lithic Spear (4-Star)", "Sacrificial Sword (4-Star)", "Sacrificial Greatsword (4-Star)", "The Widsith (4-Star)", "The Stringless (4-Star)"}}
};
...
void setup(){
	...
	characterRateupBanner = characterBannerList[characterBannerVersion];
	weaponRateupBanner = weaponBannerList[weaponBannerKeyword];
